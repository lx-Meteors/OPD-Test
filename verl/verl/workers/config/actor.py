...
class PolicyLossConfig(BaseConfig):
    ...
    Args:
        ...
        opd_max_tokens (int): Apply Student-Teacher OPD only to the first N response tokens.
            A value <= 0 applies OPD to the full response.
        extrapolation_max_tokens (int): Apply the extra G-OPD extrapolation residual only to the first
            N response tokens. A value <= 0 applies extrapolation to the full response.
    """
