...
class RolloutConfig(BaseConfig):
    ...
    reward_weight_mode: str = "student_p"  # "student_p", "teacher_p", "none", "tri" (signed triangular discrimination), "rkl_dt" (RKL vs entropy-detempered teacher), "rkl_sdt" (rKL at entropy-matched student point, 1/mu Jacobian gain), or "rkl_sdtw" (baseline rKL field reweighted by entropy-matched p~, two-sided, clamp-free)
