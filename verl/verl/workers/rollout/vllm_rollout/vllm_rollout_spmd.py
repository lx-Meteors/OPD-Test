...
class vLLMRollout(BaseRollout):
    ...
    def generate_sequences(self, prompts: DataProto, **kwargs) -> DataProto:
        ...
        train_max_tokens = int(prompts.meta_info.get("max_response_length", self.config.response_length))
        train_max_tokens = max(1, min(train_max_tokens, int(self.config.response_length)))
        if not do_sample:
            kwargs = {
                "best_of": 1,
                "top_p": 1.0,
            ...
            kwargs["max_tokens"] = train_max_tokens
        ...
        if is_validate:
            ...
            padding_max_length = train_max_tokens
