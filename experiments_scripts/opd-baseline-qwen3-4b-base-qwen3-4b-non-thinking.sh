...
export GOPD_EXTRAPOLATION_MAX_TOKENS="${GOPD_EXTRAPOLATION_MAX_TOKENS:-2048}"
...
run_opd "${OPD_RUN_NAME:-gopd-exopd-first2k-qwen3-4b-nonthinking-rl-math-step500-lambda-1.25}" "$@"
