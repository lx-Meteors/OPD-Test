...
run_opd() {
    ...
    export HANDOFF_OPD_ENABLE="${HANDOFF_OPD_ENABLE:-False}"
    export HANDOFF_OPD_CUTOFF="${HANDOFF_OPD_CUTOFF:-4096}"
    export HANDOFF_TEACHER_NUM_SAMPLES="${HANDOFF_TEACHER_NUM_SAMPLES:-1}"
    export HANDOFF_VERIFIED_SUFFIX_ONLY="${HANDOFF_VERIFIED_SUFFIX_ONLY:-False}"
    export HANDOFF_SELECT_BEST_VERIFIED_SUFFIX="${HANDOFF_SELECT_BEST_VERIFIED_SUFFIX:-False}"
    ...
    local -a cmd=(
        ...
        "actor_rollout_ref.rollout.handoff_opd.enable=${HANDOFF_OPD_ENABLE}"
        "actor_rollout_ref.rollout.handoff_opd.cutoff=${HANDOFF_OPD_CUTOFF}"
        "actor_rollout_ref.rollout.handoff_opd.teacher_num_samples=${HANDOFF_TEACHER_NUM_SAMPLES}"
        "actor_rollout_ref.rollout.handoff_opd.verified_suffix_only=${HANDOFF_VERIFIED_SUFFIX_ONLY}"
        "actor_rollout_ref.rollout.handoff_opd.select_best_verified_suffix=${HANDOFF_SELECT_BEST_VERIFIED_SUFFIX}"
        "actor_rollout_ref.rollout.handoff_opd.correct_threshold=${HANDOFF_CORRECT_THRESHOLD}"
        "actor_rollout_ref.rollout.handoff_opd.teacher_backend=${HANDOFF_TEACHER_BACKEND}"
        ...
        "actor_rollout_ref.rollout.handoff_opd.teacher_dtype=${HANDOFF_TEACHER_DTYPE}"
        "actor_rollout_ref.rollout.handoff_opd.teacher_gpu_memory_utilization=${HANDOFF_TEACHER_GPU_MEMORY_UTILIZATION}"
        "actor_rollout_ref.rollout.handoff_opd.teacher_max_model_len=${HANDOFF_TEACHER_MAX_MODEL_LEN}"
        "actor_rollout_ref.rollout.handoff_opd.teacher_max_num_batched_tokens=${HANDOFF_TEACHER_MAX_NUM_BATCHED_TOKENS}"
        "actor_rollout_ref.rollout.handoff_opd.teacher_max_num_seqs=${HANDOFF_TEACHER_MAX_NUM_SEQS}"
        "actor_rollout_ref.rollout.handoff_opd.teacher_enforce_eager=${HANDOFF_TEACHER_ENFORCE_EAGER}"
