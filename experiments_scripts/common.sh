...
run_opd() {
    ...
    local -a cmd=(
        ...
        "algorithm.set_opd_weight=${SET_OPD_WEIGHT}"
        "algorithm.set_opd_feature_dim=${SET_OPD_FEATURE_DIM}"
        "algorithm.set_opd_position_bins=${SET_OPD_POSITION_BINS}"
        "algorithm.set_opd_max_positions=${SET_OPD_MAX_POSITIONS}"
        "algorithm.set_opd_logdet_scale=${SET_OPD_LOGDET_SCALE}"
        "algorithm.set_opd_quality_weight=${SET_OPD_QUALITY_WEIGHT}"
        "algorithm.set_opd_diversity_weight=${SET_OPD_DIVERSITY_WEIGHT}"
        "algorithm.set_opd_normalize_by_std=${SET_OPD_NORMALIZE_BY_STD}"
        "algorithm.set_opd_correct_threshold=${SET_OPD_CORRECT_THRESHOLD}"
