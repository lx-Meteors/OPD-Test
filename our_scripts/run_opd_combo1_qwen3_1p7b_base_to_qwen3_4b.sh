...
export ACTOR_MODEL_PATH="${ACTOR_MODEL_PATH:-/mnt/weka/home/yongxin.wang/workspace/lark/models/Qwen/Qwen3-1.7B-Base}"
...
run_opd "combo1_qwen3_1p7b_base_to_qwen3_4b_8k" "$@"
